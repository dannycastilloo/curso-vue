<template>
  <div>
    ...
    <button @click="turnOnOff">Encender/Apagar</button>

    <br>

    <h2 :class="{ active: showName }" :style="{ backgroundColor: showName ? 'red' : 'aquamarine' }">Mi nombre es Danny</h2>
